...
<h2 style="color:#FFFFFF">CONFIGURE DEVICE</h2><br>
<form class="text-center border border-light p-5" action="conf_device.php" method="POST">
    ...
    <input type="number" name="watt" class="form-control mb-4" placeholder="Wattage"><br>
